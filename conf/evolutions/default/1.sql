...
create table cliente (
  ...
  pessoa_id                     bigint,
  constraint uq_cliente_pessoa_id unique (pessoa_id),
...
alter table cliente add constraint fk_cliente_pessoa_id foreign key (pessoa_id) references pessoa (id) on delete restrict on update restrict;
...
alter table cliente drop foreign key fk_cliente_pessoa_id;
